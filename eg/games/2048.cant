...
(let tiles
  (map<- (_    0                                      "  . ")
         (_    2  (on-blue (white                     "  2 ")))
         (_    4  (on-red (black                      "  4 ")))
         (_    8  (white (on-magenta                  "  8 ")))
         (_   16  (black (on-cyan                     " 16 ")))
         (_   32  (black (on-green                    " 32 ")))
         (_   64  (black (on-yellow                   " 64 ")))
         (_  128  (black (on-white                    "128 ")))
         (_  256  (bold (blue (on-black               "256 "))))
         (_  512  (bold (magenta (on-black            "512 "))))
         (_ 1024  (underlined (bold (red (on-black    "1024")))))
         (_ 2048  (underlined (bold (yellow (on-black "2048")))))))
